...
export default function Experience() {
    return (
        <section
            ...
            style={{ backgroundImage: `url('${process.env.PUBLIC_URL}/images/background_2.jpg')` }}
        >
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    {experiences.map((exp, idx) => (
                        <div
                            key={idx}
                            className="flex flex-col sm:flex-row items-start gap-6 bg-white border border-gray-200 rounded-xl shadow-md p-6 hover:border-blue-500 transition duration-300"
                        >
                            <div className="flex-1">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                                    ...
                                    <span className="text-sm text-gray-500 mt-2 sm:mt-0 text-left sm:text-right">
